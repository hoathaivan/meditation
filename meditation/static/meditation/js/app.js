...
function initStickyHeader() {
    ...
    window.onscroll = function () {
        if (window.pageYOffset >= sticky) {
            ...
            navbar.classList.add("nav-container-remove");
            navbar.classList.remove("nav-container-active");
        } else {
            navbar.classList.remove("sticky");
            navbar.classList.remove("nav-container-remove");
            navbar.classList.add("nav-container-active");
        }
    }
}
...
function initMusicList(breathInterval, updateProgressUIInterval, breath, updateProgressUI) {
    ...
    function playTrack() {
        ...
        play_pause_btn.innerHTML = '<i class="fa fa-pause-circle fa-2x"></i>';
    ...
    function pauseTrack() {
        ...
        play_pause_btn.innerHTML = '<i class="fa fa-play-circle fa-2x"></i>';
    ...
    function setVolume() {
        ...
        curr_track.volume = (volume_slider.value - 1) / 100;
    }
...
function initSoundList() {
    ...
    $(".sound-name-item").click(function () {
        ...
        if (_.includes(this.classList, "active")) {
            ...
            curr_sound.volume = (slider.value - 1) / 100;

            slider.addEventListener("input", function (event) {
                curr_sound.volume = (this.value - 1) / 100;
            })
